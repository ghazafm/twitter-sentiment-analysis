...
def clean_text(data, tag=False):
    ...
    print("no_alay")
    data["no_alay"] = data["no_double"].apply(clear_alay)
    ...
    if tag:
        ...
        print("stemming")
        data["stemmed"] = tokenize_data.apply(stemming)
        tokenize_data = tokenize_data.apply(stemming, token=True)

        print("stopwords")
        data["no_stopwords"] = tokenize_data.apply(clear_stopwords)
        tokenize_data = tokenize_data.apply(clear_stopwords, token=True)
        ...
        print("stemming")
        data["stemmed"] = data["clean_manual"].apply(stemming)

        print("stopword")
        data["no_stopwords"] = data["stemmed"].apply(clear_stopwords)
